	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracki uppercase dark:dark:text-gray-50">Explore</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">About us</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">practice areas</a>
					</li>
					<li>
			...
			<div className="space-y-3">
				<h3 className="uppercase dark:dark:text-gray-50">Opening Hours</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">Mon-Thu: 9:00-16:00</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Fri:9:00-13:00</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">sat:closed</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
